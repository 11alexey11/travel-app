...
const idRussia = uuidv4();
const idEngland = uuidv4();
const idItaly = uuidv4();
const idUSA = uuidv4();
const idSpain = uuidv4();
const idFrance = uuidv4();
const idChina = uuidv4();
const idIndia = uuidv4();
...
const countriesRu = [
    {
        ...
        id: idRussia,
        currencyCode: 'RUB',
        symbolCurrency: 'https://upload.wikimedia.org/wikipedia/commons/thumb/1/1c/Russian_rouble_sign_%28PT_Serif_1.000%29.svg/1200px-Russian_rouble_sign_%28PT_Serif_1.000%29.svg.png',
    ...
    },
    {
        ...
        id: idEngland,
        currencyCode: 'GBP',
        symbolCurrency: 'https://upload.wikimedia.org/wikipedia/commons/thumb/b/b9/Pound_sign.svg/1200px-Pound_sign.svg.png',
        currencyDescription: 'Курс местной валюты',
        timezone: 0,
    ...
    },
    {
        ...
        id: idItaly,
        currencyCode: 'EUR',
        symbolCurrency: 'https://image.flaticon.com/icons/png/512/25/25403.png',
        currencyDescription: 'Курс местной валюты',
        timezone: 1,
    ...
    },
    {
        ...
        id: idUSA,
        currencyCode: 'USD',
        symbolCurrency: 'https://upload.wikimedia.org/wikipedia/commons/thumb/1/14/Dollar_Sign.svg/1200px-Dollar_Sign.svg.png',
        currencyDescription: 'Курс местной валюты',
        timezone: -5,
    ...
    },
    {
        ...
        id: idChina,
        currencyCode: 'CNY',
        symbolCurrency: 'https://upload.wikimedia.org/wikipedia/commons/thumb/9/95/Yen_sign.svg/1200px-Yen_sign.svg.png',
        currencyDescription: 'Курс местной валюты',
        timezone: 8,
    ...
    },
    {
        ...
        id: idIndia,
        currencyCode: 'INR',
        symbolCurrency: 'https://upload.wikimedia.org/wikipedia/commons/thumb/9/94/Indian_rupee_sign.svg/1200px-Indian_rupee_sign.svg.png',
        currencyDescription: 'Курс местной валюты',
        timezone: 5.5,
...
module.exports = {countriesRu, countriesEn, countriesFr};